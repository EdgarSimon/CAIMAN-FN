...
namespace Cnx.CAIMAN.VendorCustomer.Fns.JSONModels
{
    ...
    public class JobsiteAdressList : JobSite
    {
        public List<Address> Address { get; set; }
    }

    public class JobsiteSigleAdress : JobSite
    {
    ...
    public class MTServiceBusJobSite
    {
        ...
        public List<JobSite> JobSitesList { get; set; }
    }

    public class MTServiceBusJobSiteAdressList: MTServiceBusJobSite
    {
        public List<JobsiteAdressList> JobSites { get; set; }
    }
    public class MTServiceBusJobSiteSingleAdress : MTServiceBusJobSite
    {
        public List<JobsiteSigleAdress> JobSites { get; set; }
    }
}
